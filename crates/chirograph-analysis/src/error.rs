...
impl fmt::Display for AnalysisError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::InvalidRepository(value) => write!(formatter, "invalid repository identity: {value}"),
            ...
            Self::InvalidCandidate(value) => write!(formatter, "invalid representation candidate: {value}"),
            Self::InvalidSchema(value) => write!(formatter, "invalid JSON Schema evidence: {value}"),
            Self::InvalidRustProjection(value) => write!(formatter, "invalid Rust projection: {value}"),
